import {
  StatsCard
} from "/build/_shared/chunk-3J6ALBQJ.js";
import {
  require_prop_types
...
var require_baseIsNative = __commonJS({
  "node_modules/lodash/_baseIsNative.js"(exports, module) {
    var isFunction21 = require_isFunction();
    ...
    function baseIsNative(value) {
      ...
      var pattern = isFunction21(value) ? reIsNative : reIsHostCtor;
...
var require_isArrayLike = __commonJS({
  "node_modules/lodash/isArrayLike.js"(exports, module) {
    ...
    function isArrayLike(value) {
      return value != null && isLength(value.length) && !isFunction21(value);
    }
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1742393477715.8884";
}
var defaultDaysMap = {
  "DTX": 7,
  "RTC": 21,
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "overflow-x-auto", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("table", { className: "min-w-full divide-y divide-gray-200", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("tbody", { className: "bg-white divide-y divide-gray-200", children: [
          projections.map((projection) => /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("tr", { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("td", { className: "px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Link, { to: `/dashboard/${projection.LOC}`, className: "text-primary-600 hover:underline", children: projection.LOC }, void 0, false, {
              fileName: "app/components/RevenueProjection.tsx",
              lineNumber: 139,
              columnNumber: 21
            }, this) }, void 0, false, {
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\components\\\\PayerDistributionChart.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1742394861844.5583";
}
var COLORS = ["#0088FE", "#00C49F", "#FFBB28", "#FF8042", "#8884D8", "#82ca9d", "#ffc658", "#8dd1e1"];
var PayerDistributionChart = ({
  claimData,
  filters
}) => {
  _s3();
  ...
  (0, import_react45.useEffect)(() => {
    ...
    const data = Object.entries(payerGroups).map(([payer, data2]) => ({
      name: payer,
      count: data2.count,
      value: metric === "count" ? data2.count : data2.totalAmount,
      totalAmount: data2.totalAmount,
      avgAmount: data2.totalAmount / data2.count
    }));
    data.sort((a2, b) => b.value - a2.value);
    if (data.length > 8) {
      ...
      const others = {
        ...
        value: metric === "count" ? otherPayers.reduce((sum, payer) => sum + payer.count, 0) : otherPayers.reduce((sum, payer) => sum + payer.totalAmount, 0)
      };
  ...
  const formatTooltip = (value, name, props) => {
    ...
    if (metric === "count") {
      ...
      return [`$${entry.totalAmount.toLocaleString("en-US", {
        maximumFractionDigits: 2
      })}`, name];
    }
  };
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex justify-between items-center pb-4", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("h4", { className: "text-md font-medium", children: "Payer Distribution" }, void 0, false, {
        fileName: "app/components/PayerDistributionChart.tsx",
        lineNumber: 105,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("select", { value: metric, onChange: handleMetricChange, className: "block w-[180px] rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("option", { value: "count", children: "Claim Count" }, void 0, false, {
          fileName: "app/components/PayerDistributionChart.tsx",
          lineNumber: 107,
          columnNumber: 11
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("option", { value: "amount", children: "Total Amount" }, void 0, false, {
          fileName: "app/components/PayerDistributionChart.tsx",
          lineNumber: 108,
          columnNumber: 11
        }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "h-80", children: chartData.length > 0 ? /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(PieChart, { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Pie, { data: chartData, cx: "50%", cy: "50%", labelLine: false, outerRadius: 80, fill: "#8884d8", dataKey: "value", nameKey: "name", label: ({
        name,
        percent
      }) => `${name}: ${(percent * 100).toFixed(0)}%`, children: chartData.map((entry, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Cell, { fill: COLORS[index % COLORS.length] }, `cell-${index}`, false, {
        fileName: "app/components/PayerDistributionChart.tsx",
        lineNumber: 118,
        columnNumber: 50
      }, this)) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Tooltip, { formatter: formatTooltip }, void 0, false, {
        fileName: "app/components/PayerDistributionChart.tsx",
        lineNumber: 120,
        columnNumber: 15
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Legend, {}, void 0, false, {
        fileName: "app/components/PayerDistributionChart.tsx",
        lineNumber: 121,
        columnNumber: 15
      }, this)
      ...
      lineNumber: 112,
      columnNumber: 33
    }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex h-full items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("p", { className: "text-gray-500", children: "No data available" }, void 0, false, {
      fileName: "app/components/PayerDistributionChart.tsx",
      lineNumber: 124,
      columnNumber: 13
    }, this) }, void 0, false, {
...
var _c4;
$RefreshReg$(_c4, "PayerDistributionChart");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
...
function Dashboard() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Layout, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex justify-between items-center mb-6", children: [
