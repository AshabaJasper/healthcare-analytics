...
import PayerDistributionChart from "~/components/PayerDistributionChart";
  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto">
        ...
        {/* LOC Breakdown & Payer Distribution */}
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="px-4 py-5 sm:p-6">
              {filteredClaimData.length > 0 ? (
                <PayerDistributionChart claimData={filteredClaimData} filters={currentFilters} />
              ) : (
